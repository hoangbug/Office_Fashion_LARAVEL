    ...
    <div class="col-md-12">
        <div class="row mb-25">
            ...
            <div class="col-md-8 p-0 d-flex justify-content-end">
                <a class="d-flex justify-content-end align-items-center reload-data" style="width: 60px;">
                    <i class="fa fa-refresh" aria-hidden="true" style="color: #fff; background: #2ecc71; width: 50px; height: 50px; text-align: center; line-height: 54px; font-size: 35px; border-radius: 100%; cursor: pointer;"></i>
                </a>
            </div>
        </div>
    </div>
